...
class TGEnv(LeggedRobot):
    ...
    def compute_observations(self):
        ...
        self.obs_buf = torch.cat((self.base_ang_vel * self.obs_scales.ang_vel,  # 3
                                  ...
                                  (self.dof_pos - self.default_dof_pos) * self.obs_scales.dof_pos,  # 20
    ...
    def _reward_dof_error(self):
        return torch.sum(torch.square(self.dof_pos - self.default_dof_pos)[:, 12:], dim=1)
